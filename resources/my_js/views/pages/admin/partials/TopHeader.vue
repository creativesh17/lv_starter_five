        ...
        >
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" @click="showbar"  data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                        <i class="ti ti-bell ti-md"></i>
                        <span class="badge bg-danger rounded-pill badge-notifications">5</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end py-0" :class="show == true ? 'show':''" >
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar">
                                                <img src="/contents/backend/assets/img/avatars/1.png" alt="" class="h-auto rounded-circle"/>
                                            </div>
                                        </div>
                                ...
                                <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar">
                                                <img src="/contents/backend/assets/img/avatars/2.png" alt="" class="h-auto rounded-circle"/>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                >
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar">
                                                <img
                                                    src="/contents/backend/assets/img/avatars/9.png"
                                                    alt
                                ...
                                >
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar">
                                                <img
                                                    src="/contents/backend/assets/img/avatars/5.png"
                                                    alt
                                                    class="h-auto rounded-circle"
                                                />
                                            </div>
                                ...
                                >
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar">
                                                <img
                                                    src="/contents/backend/assets/img/avatars/6.png"
                                                    alt
                                                    class="h-auto rounded-circle"
                                                />
                                            </div>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    ...
                    >
                        <div class="avatar avatar-online">
                            <img
                                src="/contents/backend/assets/img/avatars/1.png"
                                alt=""
                                class="h-auto rounded-circle"
                            />
                        </div>
